...
$LogFile = "ExportUserLoginsLog";
$OutputFile ="ExportUserLogins";
##usage:

##To export all mailboxes who have not logged on since last 30 days [30 is the default period here in script]
##.\ExportUserLogins.ps1 -User AD\administrator -Password ok -ExchangeServer 192.168.10.10

##To export all mailboxes who have not logged on since last 60 days 
##.\ExportUserLogins.ps1 -User AD\administrator -Password ok -ExchangeServer 192.168.10.10 -NumberOfDays 60
